...
public class FrmTicket extends javax.swing.JFrame {
    ...
    public void tampilkanData() {
        String[] kolom = {"ID Ticket", "Train", "Schedule", "Seat", "Classs"};
        ArrayList<Ticket> list = new Ticket().getAll();
        Object rowData[] = new Object[5];
        
        tblTicket.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for(int i = 0; i < list.size(); i++) {
            rowData[0] = list.get(i).getIdticket();
            rowData[1] = list.get(i).getTrain().getTrainname();
            rowData[2] = list.get(i).getSchedule();
            rowData[3] = list.get(i).getSeat();
            rowData[4] = list.get(i).getClasss();
            
            ((DefaultTableModel)tblTicket.getModel()).addRow(rowData);
        }
    }
    
    public void search(String keyword) {
        String[] kolom = {"ID Ticket", "Train", "Schedule", "Seat", "Classs"};
        ArrayList<Ticket> list = new Ticket().search(keyword);
        Object rowData[] = new Object[5];
    ...
    private void initComponents() {
        ...
        tblTicket.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Ticket", "Train Name", "Schedule", "Seat", "Class"
            }
        ));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtSchedule, javax.swing.GroupLayout.DEFAULT_SIZE, 196, Short.MAX_VALUE)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        ticket.setIdticket(Integer.parseInt(txtIdTicket.getText()));
        ticket.setTrain((Train)cmbTrain.getSelectedItem());
        ticket.setSchedule(txtSchedule.getText());
        ticket.setSeat(txtSeat.getText());
        ticket.setClasss(txtClass.getText());
        ticket.save();
        
        txtIdTicket.setText(Integer.toString(ticket.getIdticket()));
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        Ticket ticket = new Ticket().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        ticket.delete();
        kosongkanForm();
        tampilkanData();
    ...
    private void tblTicketMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTicketMouseClicked
        ...
        ticket = ticket.getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        
        txtIdTicket.setText(String.valueOf(ticket.getIdticket()));
        cmbTrain.getModel().setSelectedItem(ticket.getTrain().getTrainname());
        txtSchedule.setText(ticket.getSchedule());
        txtSeat.setText(ticket.getSeat());
        txtClass.setText(ticket.getClasss());
