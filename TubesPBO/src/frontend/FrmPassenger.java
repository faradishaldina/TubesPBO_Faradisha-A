...
public class FrmPassenger extends javax.swing.JFrame {
    ...
    public void tampilkanData() {
        String[] kolom = {"ID Passenger", "Passenger Name", "Address", "Gender", "Phone"};
        ArrayList<Passenger> list = new Passenger().getAll();
        Object rowData[] = new Object[5];
        
        tblPassenger.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for(Passenger p : list) {
            rowData[0] = p.getIdpassenger();
            rowData[1] = p.getPassengername();
            rowData[2] = p.getAddress();
            rowData[3] = p.getGender();
            rowData[4] = p.getPhone();
            
            ((DefaultTableModel)tblPassenger.getModel()).addRow(rowData);
        }
    }
    
    public void search(String keyword) {
        String[] kolom = {"ID Passenger", "Passenger Name", "Address", "Gender", "Phone"};
        ArrayList<Passenger> list = new Passenger().search(keyword);
        Object rowData[] = new Object[5];
    ...
    private void initComponents() {
        ...
        txtIdPassenger.setEnabled(false);
        ...
        tblPassenger.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Passenger", "Passenger Name", "Address", "Gender", "Phone"
            }
        ));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtIdPassenger, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txtPassengerName, javax.swing.GroupLayout.DEFAULT_SIZE, 196, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel3)
                    .addComponent(txtIdPassenger, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        passenger.setIdpassenger(Integer.parseInt(txtIdPassenger.getText()));
        passenger.setPassengername(txtPassengerName.getText());
        passenger.setAddress(txtAddress.getText());
        passenger.setGender(txtGender.getText());
        passenger.setPhone(txtPhone.getText());
        passenger.save();
        
        txtIdPassenger.setText(Integer.toString(passenger.getIdpassenger()));
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        Passenger passenger = new Passenger().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        passenger.delete();
        kosongkanForm();
        tampilkanData();
    ...
    private void tblPassengerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPassengerMouseClicked
        ...
        passenger = passenger.getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        
        txtIdPassenger.setText(String.valueOf(passenger.getIdpassenger()));
        txtPassengerName.setText(passenger.getPassengername());
        txtAddress.setText(passenger.getAddress());
        txtGender.setText(passenger.getGender());
        txtPhone.setText(passenger.getPhone());
